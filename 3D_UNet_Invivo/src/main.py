"""
Train 3D U-Net network, for MRA Atherosclerotic Carotid Scans.
...
def main(argv):
    ...
    # -------------------------------------------------------------------------
    # create model
    # saving checkpoint: https://www.tensorflow.org/versions/r1.15/api_docs/python/tf/estimator/RunConfig
    # -------------------------------------------------------------------------
    print('Creation Unet Model Starting...........****...............................................*****')
    ...
    print('Creation Unet Model is successful...................****.........................*****')
    ...
    if args.mode in ['train_eval', 'train']:
        model.train(
            input_fn=lambda: input_fn(1, params),
    ...
    if args.mode in ['train_eval', 'eval']:
        model.evaluate(input_fn=lambda: input_fn(2, params))
    ...
    if args.mode == 'predict':
        predictions = model.predict(input_fn=lambda: input_fn(3, params))
    ...
    print('Model Prediction is successful...................****.....................*****')
