"""
Implementation of 3D U-Net building function.
...
def unet_3d_network(inputs, params, training):
    """
    Original paper: https://arxiv.org/abs/1606.06650
    different padding modes: https://stackoverflow.com/questions/37674306/what-is-the-difference-between-same-and-valid-padding-in-tf-nn-max-pool-of-t
...
#    # range(start, stop, step) 
     # up_conv errors:  see https://github.com/tensorflow/tensorflow/issues/10520
